...
test("passes root-relative URLs through", () => {
  assert.equal(safeDownloadUrl("/downloads/Termi.dmg"), "/downloads/Termi.dmg");
  assert.equal(safeDownloadUrl("/Termi.dmg"), "/Termi.dmg");
});
...
test("rejects unsafe schemes", () => {
  ...
  assert.equal(safeDownloadUrl("//evil.test/Termi.dmg"), DEFAULT_DMG_URL);
});
